                ...
                <Card.Body>
                    ...
                    <Form>
                        ...
                        <Form.Group controlId="formBasicEBal">
                            <Form.Label style={{  marginRight: '100px', fontSize: '15px' }}>CurrentBalance: {user.currentbalance}</Form.Label>
                        </Form.Group>
